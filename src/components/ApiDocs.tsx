            ...
            <table className="w-full text-left text-sm text-zinc-300 border-collapse">
              ...
              <tbody className="divide-y divide-white/5">
                ...
                <tr className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-4 px-5 text-zinc-400">Opsi penyimpanan. Bisa 'private' (DCDN Master Network), atau 'temporary' (Hapus otomatis dalam 24 jam).</td>
                </tr>
                <tr className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-4 px-5 text-zinc-400">Jika durasi 'private', jumlah jam sebelum hapus otomatis (hanya didukung oleh sebagian jaringan). 0 = selamanya.</td>
                </tr>
              </tbody>
            </table>
          </div>
